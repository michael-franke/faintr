...
fit_brms_politeness <- faintr:::fit_brms_politeness
```
...
fit_brms_politeness_sum <- faintr:::fit_brms_politeness_sum
```
...
fit_brms_politeness_sum_prior <- faintr:::fit_brms_politeness_sum_prior
```
