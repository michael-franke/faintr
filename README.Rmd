...
* `get_cell_definitions` returns information on the models' predictor variables 
...
To obtain posterior draws for a specific design cell, we can use `extract_cell_definitions`. 
For instance, draws for women in the 2nd class can be extracted like so:
...
we compare the odds of surviving between female passengers in the first class with
